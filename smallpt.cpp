...
struct Scene {
    std::vector<Sphere> spheres{
        ...
        // 2
        { V(1e5+1.0, 40.8, 81.6), 1e5 },  // left
        { V(-1e5+99, 40.8, 81.6), 1e5 },          // right
        { V(50, 40.8, 1e5), 1e5 },             // front
        // { V(50, 40.8, -1e5 + 170), 1e5 },
        { V(50, 1e5, 81.6), 1e5 },           // bottom
        { V(50, -1e5+81.6, 81.6), 1e5 },        // top
        { V(27, 16.5, 47), 16.5 },           // left - ball
        { V(73, 16.5, 78), 16.5 },       // right - ball
        { V(50, 681.6-.27, 81.6), 600 },    // light
    ...
    */
    ...
    for(int i = 0; i < w * h; i++) {
        ...
        ray.d = [&]() {
            ...
            // ???
            const double rpx = 2.*x/w-1.0;
            const double rpy = 2.*y/h-1.0;
